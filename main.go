...
import (
	...
	"github.com/david1312/go_application_structure/courses"
)
...
func main() {
	...
	fmt.Println("per course section ====")
	...
	// courses.TypeAndZeroValues()
	// courses.NamingConvention()
	// courses.FMTPackageLearning()
	// courses.TypedVsUntypedConst()

	courses.IotaExample() //course 29
